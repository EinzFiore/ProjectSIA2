            ...
            <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $sp->alamat}}</td>
                        <td>{{ $sp->telepon}}</td>
                        <td align="center"><a href="{{route('supplier.edit',[$sp->kd_supp])}}"
                                class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
                                <i class="fas fa-edit fa-sm text-white-50"></i> Edit</a>
                            <a href="/supplier/hapus/{{$sp->kd_supp}}"
...
1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
            ...
            <form action="{{ action('SupplierController@store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="kd_supp" id="kd_supp" class="form-control" maxlegth="5"
                            id="exampleFormControlInput1">
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Nama Supplier</label>
                        <input type="text" name="nm_supp" id="addnmbrg" class="form-control"
                            id="exampleFormControlInput1">
                    </div>
                    <div class="form-group">
