            ...
            <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $a->no_akun}}</td>
                        <td>{{ $a->nm_akun}}</td>
                        <td align="center"><a href="{{route('akun.edit',[$a->no_akun])}}"
                                class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
                                <i class="fas fa-edit fa-sm text-white-50"></i> Edit</a>
                            <a href="/akun/hapus/{{$a->no_akun}}"
            ...
            <form action="{{ action('AkunController@store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="no_akun" id="no_akun" class="form-control" maxlegth="5"
                            id="exampleFormControlInput1">
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Nama Akun</label>
                        <input type="text" name="nm_akun" id="nm_akun" class="form-control"
                            id="exampleFormControlInput1">
                    </div>
                </div>
